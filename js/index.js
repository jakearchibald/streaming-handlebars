...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StreamingJavaScriptCompiler = __webpack_require__(29);
	
	var _StreamingJavaScriptCompiler2 = _interopRequireDefault(_StreamingJavaScriptCompiler);
	...
	{
	  const oldEscape = _handlebars2.default.Utils.escapeExpression;
	
	  _handlebars2.default.Utils.escapeExpression = function escapeExpression(val) {
	...
	const env = _handlebars2.default.create();
	env.JavaScriptCompiler = _StreamingJavaScriptCompiler2.default;
	(0, _helpers2.default)(env);
	
	// Patching compiler
	{
	  const oldCompile = _handlebars2.default.compile;
	
	  _handlebars2.default.compile = (input, options = {}) => {
	    if (options.stream) {
	      return env.compile(input, options);
	    }
	    return oldCompile.call(undefined, input, options);
	  };
	}
	
	// Patching precompiler
	{
	  const oldPrecompile = _handlebars2.default.precompile;
	
	  _handlebars2.default.precompile = (input, options = {}) => {
	    if (options.stream) {
	      return env.precompile(input, options);
	    }
	    return oldPrecompile.call(undefined, input, options);
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _handlebarsCompilerAst = __webpack_require__(20);
	...
	var _handlebarsCompilerVisitor = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _whitespaceControl = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	class StreamingJavaScriptCompiler extends _handlebars2.default.JavaScriptCompiler {
	  mergeSource(varDeclarations) {
	    ...
	    this.source.each(line => {
	      if (line.appendToBuffer) {
	        ...
	        // TODO: I don't know when this block happens
	        if (bufferStart) {
	          if (!sourceSeen) {
	            appendFirst = true;
	          } else {
	...
	exports.default = StreamingJavaScriptCompiler; // prevent falling back to the old compiler in recursive calls
